...
/**
 * Created by UDS_Estructuracion on 05/07/2016.
 */
public class ServiceUninstallNotification extends Service {
    ...
    private class MyAsyncTask extends AsyncTask<Integer,Integer,Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            if(result){
                ...
                mNotified.setContentTitle(getResources().getString(R.string.service_Title_uninstall_End));
                mNotified.setContentText(getResources().getString(R.string.service_Text_uninstall_End));
                mNotified.setContentInfo(getResources().getString(R.string.service_Info_uninstall_End));
                mNotified.setAutoCancel(true);
                mNotified.setStyle(new NotificationCompat.BigTextStyle().bigText(getResources().getString(R.string.service_Info_uninstall_End)));
